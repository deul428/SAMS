...
/* 
    ...
    const treeRender = (listData, propsData, type) => {
        ...
        return listData.map((e, index) => {
            const selectedRadio = inputValues[e.great_classi_code.toLowerCase()][e.small_classi_code]?.[2] ?? false;
                ...
                title: (
                    <div className="titleArea"
                        ...
                        <input 
                            ...
                            checked={inputValues[e.great_classi_code.toLowerCase()][e.small_classi_code]?.[2] === false ? false : matchedData.delegate_tf}
                        />

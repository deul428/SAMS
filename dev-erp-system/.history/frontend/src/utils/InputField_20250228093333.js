    ...
    */
    ...
    const f_handlingDept = (e) => {
        if (e.target.name === 'a_headquarters_dept_id') {
            setInput((prevInput) => ({
                ...prevInput,
                a_headquarters_dept_id: '', // 본부 선택 초기화
                a_dept_id: '', // 팀도 초기화
            }));
            setVSelectTeam(v_teamByDept[e.target.value.trim()] || []);
            // setVSelectTeam([]); // 팀 옵션도 초기화
        }
        f_handlingInput(e); // 다른 로직 유지
    };
    // --------- 본부별 팀 매핑 끝 --------- 
                        ...
                        <div className='inputField'>
                            <div className='searchItem'>
                                ...
                                <Row className='d-flex justify-content-end btnRow'>
                                    <Col xs={12} md={12} lg={3} xl={4} className='btnCol col d-flex justify-content-end floating'>
                                ...
                                <Row className='d-flex justify-content-start'>
                                    ...
                                    <Col xs={12} md={6} lg={3} xl={4}className='col d-flex align-items-center justify-content-start floating'>

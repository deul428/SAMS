              ...
              {Object.entries(groupedData).map(([biz_opp_id, group], groupIndex) => {
                ...
                return (
                  ...
                  <div key={groupIndex} className='mb-4 d-flex flex-column'>
                    <tbody>
                      <div className='row'>
                        <div className='col col_01 col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>사업 번호</th>
                          <td>{commonInfo.biz_opp_id}</td>
                        </div>
                        <div className='col col_02 col-xl-8 col-lg-8 col-md-12 col-12'>
                          <th>사업명</th>
                    ...
                    <tbody>
                      <div className='row'>
                        <div className='col col_03 col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>소속 본부</th>
                          <td>{commonInfo.change_preparation_high_dept_name}</td>
                        </div>
                        <div className='col col_04 col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>팀</th>
                          <td>{commonInfo.change_preparation_dept_name}</td>
                        </div>
                        <div className='col col_05 col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>담당자</th>
                    ...
                    <tbody>
                      <div className='row'>
                        <div className='col col_06 col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>계약 일자</th>
                          <td>{commonInfo.contract_date.replace(/(\d{4})(\d{2})(\d{2})/g, '$1-$2-$3')}</td>
                        </div>
                        <div className='col col_07 col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>매출 일자</th>
                          <td>{commonInfo.sale_date.replace(/(\d{4})(\d{2})(\d{2})/g, '$1-$2-$3')}</td>
                        </div>
                        <div className='col col_08 col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>매출 금액</th>
                    ...
                    <tbody>
                      <div className='row'>
                        <div className='col col_09 col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>매출 이익</th>
                          <td>{commonInfo.sale_profit.toLocaleString('ko-KR')}</td>
                        </div>
                        <div className='col col_10 col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>대표 사업 구분</th>
                          <td>{commonInfo.delegate_biz_section2_name}</td>
                        </div>
                        <div className='col col_11 col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>대표 제조사명</th>
                      ...
                      (
                        ...
                        <tbody>
                          {group.map((item, index) => (
                            ...
                            <Collapse in={openStates[biz_opp_id] || false}>
                              <div className='row'>
                                <div id={`collapse-${biz_opp_id}`} className='collapseBox' key={index} onClick={(e) => openModal(e, group[index], 'activity')}>
                                  <div className='col col_11 col-xl-2 col-lg-2 col-md-4 col-12'>
                                    <th>상세 번호</th>
                                    <td>{item.detail_no}</td>
                                  </div>
                                  <div className='col col_12 col-xl-2 col-lg-2 col-md-4 col-12'>
                                    <th>활동 일자</th>
                                    <td>{item.activity_date.replace(/(\d{4})(\d{2})(\d{2})/g, '$1-$2-$3')}</td>
                                  </div>
                                  <div className='col col_13 col-xl-8 col-lg-8 col-md-4 col-12'>
                                    <th>활동 내역</th>
                            ...
                            <div className='row'>
                              <div id={`collapse-${biz_opp_id}`} className='collapseBox' key={index} onClick={(e) => openModal(e, group[index], 'activity')}>
                                <div className='col col_11 col-xl-2 col-lg-4 col-md-4 col-12'>
                                  <th>상세 번호</th>
                                  <td>{item.detail_no}</td>
                                </div>
                                <div className='col col_12 col-xl-2 col-lg-4 col-md-4 col-12'>
                                  <th>활동 일자</th>
                                  <td>{item.activity_date.replace(/(\d{4})(\d{2})(\d{2})/g, '$1-$2-$3')}</td>
                                </div>
                                <div className='col col_13 col-xl-8 col-lg-4 col-md-4 col-12'>
                                  <th>활동 내역</th>
                                  <td className='activityDetails'>{item.activity_details}</td>
                                </div>
                              </div>

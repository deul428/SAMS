                                    ...
                                    <div className="inputField">
                                        ...
                                        <Row className="cntntArea">
                                            <Col xs={12} md={12} lg={6} xl={6} className="cntnt textArea">
                                                ...
                                                <h4>현재 사업 구분 금액: &#65510;
                                                    {sumBiz >= 0 && typeof sumBiz === 'number' ? sumBiz.toLocaleString('ko-KR') : v_modalPropsData?.sale_amt.toLocaleString('ko-KR')}
                                                </h4>
                                            ...
                                            <Col xs={12} md={12} lg={6} xl={6} className="cntnt">
                                                ...
                                                <h4>
                                                    현재 제조사명 금액: &#65510;
                                                    {sumCor >= 0 && typeof sumCor === 'number' ? sumCor.toLocaleString('ko-KR') : v_modalPropsData?.sale_amt.toLocaleString('ko-KR')}
                                                </h4>
                                                <Tree ref={treeRef} multiple checkStrictly 

    ...
    */
    ...
    useEffect(() => {
        if (v_propsSaleData.length !== 0 && v_propsSaleData.some(el => el)) {
            ...
            // 나중에 small classi name 들어오면 이 객체 삭제제
            ...
            setInputValues({
                ...inputValues,
                biz: {
                    ...inputValues.biz,  // 기존 biz 데이터 유지
                    ...transformedData.biz // 새 데이터 추가
                },
                cor: {
                    ...inputValues.cor,  // 기존 biz 데이터 유지
                    ...transformedData.cor // 새 데이터 추가
                },
                a_product_name: transformedData.a_product_name || inputValues.a_product_name // 새로운 값이 있으면 업데이트
            })
    ...
    }, [v_modalPropsData, v_propsSaleData])
/* 
    useEffect(() => {

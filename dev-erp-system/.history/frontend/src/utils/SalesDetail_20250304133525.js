 ...
 */
            ...
            const selectedRadio = matchedData.delegate_tf ? matchedData.delegate_tf : inputValues[e.great_classi_code.toLowerCase()][e.small_classi_code]?.[2];
            /* const selectedRadio = isSelected
            ? inputValues[e.great_classi_code.toLowerCase()][e.small_classi_code]?.[2] ?? matchedData.delegate_tf
            : false; */
            if (isSave === true) {
                const selectedRadio = inputValues[type]?.[e.small_classi_code]?.[2] ?? false;

                console.log(inputValues[type], selectedRadio);
                ...
                title: (
                    <div className="titleArea"
                        ...
                        <input 
                            ...
                            defaultChecked={
                                isSave ? selectedRadio : matchedData.delegate_tf
                            }
                        />

                                    ...
                                    <div className="inputField">
                                        ...
                                        <Row className="cntntArea mb-2">
                                            <Col xs={12} md={12} lg={12} xl={12} className='col d-flex align-items-center floating'>
                                                <h3>총 매출 금액 &#40;수정 전 값&#41;: &#65510;{v_modalPropsData ? v_modalPropsData?.total_amt.toLocaleString('ko-KR') : ''}</h3>
                                            </Col>
                                        ...
                                        <Row className="cntntArea">
                                            <Col xs={12} md={12} lg={6} xl={6} className="cntnt textArea">
                                                ...
                                                <h4>현재 사업 구분 금액: &#65510;
                                                    {typeof sumBiz === 'number' && sumBiz >= 0 ? sumBiz.toLocaleString('ko-KR') : v_modalPropsData?.total_amt.toLocaleString('ko-KR')}
                                                </h4>

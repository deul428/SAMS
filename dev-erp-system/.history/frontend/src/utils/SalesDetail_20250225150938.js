...
const SalesDetail = ({ v_treeName, show, onHide, listData, v_modalPropsData, v_propsSaleData, setSalesDetailData }) => {
    ...
    */
    ...
    useEffect(() => {
        if (listData) {
            ...
            if (v_propsSaleData.length !== 0 || v_propsSaleData.some(el => el)) {
                ...
                setDefaultBizKeys(propsBizData.map((e) => {
                    defaultBizKeys.push(e.small_classi_code);
                }));
                setDefaultCorKeys(propsBizData.map((e) => {
                    defaultCorKeys.push(e.small_classi_code);
                }));
            } else {
                return;
            }
    ...
    useEffect(() => {
        console.log(defaultBizKeys, defaultCorKeys);
                                    ...
                                    <div className="inputField">
                                        ...
                                        <Row className="cntntArea">
                                            ...
                                            <Col xs={12} md={12} lg={6} xl={6} className="cntnt">
                                                ...
                                                defaultSelectedKeys={defaultBizKeys.map((e) => `cor-${e}`)}

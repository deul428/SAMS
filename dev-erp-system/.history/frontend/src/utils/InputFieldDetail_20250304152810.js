...
/* 
    ...
    useEffect(() => {
        console.log('props된 salesDetailData:' , salesDetailData, 'a_v_modalPropsData: ', a_v_modalPropsData);
        ...
        if (salesDetailDataArr.length > 0) {
            ...
            if (filteredResult.length > 0) {
                ...
                if (a_v_modalPropsData.a_product_name === salesDetailData.a_product_name) {

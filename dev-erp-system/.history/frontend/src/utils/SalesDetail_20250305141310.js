        ...
        */
        if (show === false) {
            ...
            if (isParentHide === true) {
                ...
                if (isSave === true) { //case2
                    console.log('isSave true');
                } else { //case3
                    console.log('isParentHide false');
                    if (v_propsSaleData.length !== 0) { //case3-1
                        console.log('propsData O', v_propsSaleData);
                    } else { //case3-2
                        console.log('propsData X', v_propsSaleData, v_propsSaleData.length);
                        setIsSave(false);
                        setSumBiz(null);
                        setSumCor(null);
                        setInputValues({biz: {}, cor: {}, a_product_name: ''});

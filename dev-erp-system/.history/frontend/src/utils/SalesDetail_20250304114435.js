...
/* 
    ...
    const treeRender = (listData, propsData, type) => {
        ...
        const inputMap = new Map(Object.entries(inputValues).map(e => [e.small_classi_code, { sale_amt: e.sale_amt, delegate_tf: e.delegate_tf }]));
        console.log(propsMap, inputValues);

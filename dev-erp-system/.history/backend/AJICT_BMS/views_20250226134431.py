...
def f_select_biz_opp1(request):
    ...
    try:
        ...
        # 비즈니스 기회 조회
        v_sql_biz_opp = """SELECT DISTINCT ON (A.biz_opp_id, B.detail_no)
                              A.biz_opp_id,
                              A.biz_opp_name,
                              B.detail_no,
                              B.user_id,

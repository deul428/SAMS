...
const Trees = ({ v_treeName, show, onHide, listData, v_modalPropsData, setSalesDetailData }) => {
    ...
    const saveData = (e) => {
        ...
        setSalesDetailData(inputValues);
        onHide(true);
    }
                                    ...
                                    <div className="inputField">
                                        ...
                                        <Row className="cntntArea">
                                            ...
                                            <Col className="cntnt">
                                                ...
                                                <Tree ref={treeRef} multiple checkStrictly treeData={treeRender(corTreeData, 'cor')} onSelect={(selectedKeys, info) => onSelect('cor')(selectedKeys, info)}
                                                /> 
                                            </Col>
                                        </Row>
                                    </div>

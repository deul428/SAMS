...
/* 
    ...
    const treeRender = (listData, propsData, type) => {
        ...
        if (inputValues.biz || inputValues.cor) {
            const inputArr = Object.envaluestries(inputValues);
            inputArr.map((e, index) => {
                if(e[0] === 'biz' || e[0] === 'cor'){
                    console.log("e:" , e);
                    console.log(e[1][index]);
                    const { code, amt, delegateFlag } = e;
                ...
                title: (
                    <div className="titleArea"
                        ...
                        <input 
                            ...
                            defaultChecked={matchedData.delegate_tf || inputData.a_delegate_tf}

    ...
    return (
        <div id='inputFieldDetail'>
            {v_handlingHtml}
            {
                ...
                <SalesDetail v_treeName={v_childComponent} isParentHide={isParentHide} show={showModal} onHide={closeModal} listData={detailData} v_modalPropsData={v_modalPropsData} v_propsSaleData={[saleBizData, saleCorData]} setSalesDetailData={setSalesDetailData} hideMsg={hideMsg}/>
                : ''
            }
        </div>
    );

...
const InputFieldDetail = ({ show, onHide, v_componentName, v_propsData, v_modalPropsData, mode }) => {
    ...
    const p_bizopp = {
        ...
        // a_progress1_rate_name: '',
        a_progress2_rate_name: '',
        a_purchase_amt: 0,
        a_purchase_date: '',
        a_sale_amt: 0,
        // a_sale_com1_code: '',
                                            ...
                                            <Row className='d-flex justify-content-between'>
                                                <Col xs={12} md={6} lg={4} className='col d-flex align-items-center floating'>
                                                    <FloatingLabel label='최종 고객사 (선택)'>
                                                        <Form.Control name='last_client_com2_name' size='sm' type='text' className='' placeholder='최종 고객사 (선택)'
                                                        onChange={f_handlingInput} 
                                            ...
                                            <Row className='d-flex justify-content-between'>
                                                ...
                                                <Col xs={12} md={6} lg={4} className='col d-flex align-items-center floating'>
                                                    <FloatingLabel label='수금 일자 (선택)'>
                                                        <Form.Control name='collect_money_date' size='sm' type='date' className='' placeholder='수금 일자 (선택)'
                                                        onChange={f_handlingInput}

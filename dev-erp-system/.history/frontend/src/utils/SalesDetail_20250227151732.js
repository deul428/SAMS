...
/* 
                    ...
                    <div className="titleArea"
                        ...
                        <div className={`${index} titleItem`} data-key={`${type}-${index}`}>
                            ...
                            <input
                                ...
                                value={matchedData.sale_amt ? matchedData.sale_amt : inputNumValue}
                                // value={e => isSelected === false ? 0 : ''}
                                data-key={e.small_classi_name}
                                data-code={e.small_classi_code}
    ...
    useEffect(() => {
        if (isSelected === false) {
            ...
            setInputNumValue(0);
            console.log(isSelected, inputNumValue);
        } 
    }, [isSelected]);
    // =================== onSelect 시 핸들링 끝 ===================  
                                    ...
                                    <div className="inputField">
                                        ...
                                        <Row className="cntntArea">
                                            <Col xs={12} md={12} lg={6} xl={6} className="cntnt textArea">
                                                ...
                                                <h4>현재 사업 구분 금액: &#65510;
                                                    {v_modalPropsData ? v_modalPropsData?.sale_amt.toLocaleString('ko-KR') : sumBiz.toLocaleString('ko-KR')}
                                                </h4>
                                            ...
                                            <Col xs={12} md={12} lg={6} xl={6} className="cntnt">
                                                ...
                                                <h4>
                                                    현재 제조사명 금액: &#65510;
                                                    {v_modalPropsData ? v_modalPropsData.sale_amt.toLocaleString('ko-KR') : sumCor?.toLocaleString('ko-KR') }
                                                </h4>
                                                <Tree ref={treeRef} multiple checkStrictly 

...
from .views import f_select_biz_opp_activity1,f_select_biz_opp_activity2,f_select_biz_opp_history1,f_select_biz_opp_history2
urlpatterns = [path('login/',f_login,name='login'),
               ...
               path('select-biz-opp-history1/',f_select_biz_opp_history1,name = 'select-biz-opp-history1'),
               path('select-biz-opp-history2/',f_select_biz_opp_history2,name = 'select-biz-opp-history2')]
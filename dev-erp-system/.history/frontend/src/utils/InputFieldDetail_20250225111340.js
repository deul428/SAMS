...
/*     useEffect(() => {
    ...
    const [salesBizData, setSalesBizData] = useState(null);
    const [salesCorData, setSalesCorData] = useState(null);
            ...
            try {
                ...
                if (response?.status?.STATUS === 'NONE' || response[0]?.STATUS === 'FAIL') {
                    ...
                    if (msg === '사업데이터조회') {
                        ...
                        setSalesBizData(response.data.select_biz_opp_detail_sale_biz);
                        setSalesCorData(response.data.select_biz_opp_detail_sale_cor);
                        return response;
                    } else if (msg === '조회') {

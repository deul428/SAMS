...
function DynamicTable({ v_componentName, v_propsData }) {
  ...
  const [v_handlingHtml, setVHandlingHtml] = useState();
  ...
  useEffect(() => {
    ...
    const updatedData = v_propsData.data.retrieve_biz_opp;
    console.log(updatedData, Object.values(updatedData));
    setData(Object.values(updatedData)[0]);

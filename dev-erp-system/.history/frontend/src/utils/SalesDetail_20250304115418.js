    ...
    const treeRender = (listData, propsData, type) => {
        ...
        return listData.map((e, index) => {
            ...
            if (inputValues.biz || inputValues.cor) {
                ...
                console.log(inputArr, inputArr[index]);
                // inputArr.map((e, index) => {
                    if(inputArr[0][index] === 'biz' || inputArr[1][index] === 'cor'){
                        console.log(`------------------------${index}--------------------`)
                        console.log(inputArr[0][index],  inputArr[1][index]);
                        const arr = inputArr[0][index];
                        console.log(arr);

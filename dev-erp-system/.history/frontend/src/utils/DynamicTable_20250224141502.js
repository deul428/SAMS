                    ...
                    {group.length > 5 ? 
                            ...
                            <Collapse in={openStates[biz_opp_id] || false}>
                              <div className='row'>
                                <div id={`collapse-${biz_opp_id}`} className='collapseBox' key={index} onClick={(e) => openModal(e, group[index], 'activity')}>
                                  <div className='col col-xl-2 col-lg-2 col-md-6 col-12'>
                                    <th>상세 번호</th>
                      ...
                      <tbody>
                        {group.map((item, index) => (
                          <div className='row'>
                            <div id={`collapse-${biz_opp_id}`} className='collapseBox' key={index} onClick={(e) => openModal(e, group[index], 'activity')}>
                              <div className='col col-xl-2 col-lg-4 col-md-6 col-12'>
                                <th>상세 번호</th>
                                <td>{item.detail_no}</td>
                              </div>
                              <div className='col col-xl-2 col-lg-4 col-md-6 col-12'>
                              ...
                              <div className='col col-xl-8 col-lg-4 col-md-6 col-12'>
                                <th>활동 내역</th>

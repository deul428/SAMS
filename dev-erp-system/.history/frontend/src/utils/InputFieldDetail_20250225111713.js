...
/* 
    ...
    return (
        <div id='inputFieldDetail'>
            {v_handlingHtml}
            <SalesDetail v_treeName={v_childComponent} show={showModal} onHide={closeModal} listData={listData} v_modalPropsData={v_modalPropsData} v_propsSaleData={[saleBizData, saleCorData]} setSalesDetailData={setSalesDetailData} />
        </div>
    );
};

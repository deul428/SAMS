            ...
            try {
                ...
                if (response?.status?.STATUS === 'NONE' || response[0]?.STATUS === 'FAIL') {
                    ...
                    if (msg === '사업데이터조회') {
                        ...
                        console.log([response.data.select_biz_opp_detail_sale_biz, response.data.select_biz_opp_detail_sale_cor]);
                        return response;
                    } else if (msg === '조회') {
    ...
    return (
        <div id='inputFieldDetail'>
            {v_handlingHtml}
            {
                ...
                v_propsSaleList={/* Object.entries(saleData).flat().length === 0 ? null :  */saleData}

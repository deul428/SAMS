...
/*     useEffect(() => {
    ...
    const [inputValues, setInputValues] = useState({biz: {}, cor: {}, a_product_name: '', a_total_biz_sale_amt: 0, a_total_cor_sale_amt: 0});
        ...
        setInputValues((prev) => {
            return {
                ...
                ...(type !== 'biz' && type !== 'cor' ?
                    ...
                    (type === 'a_product_name') ?
                        { a_product_name: value }  : 
                        { a_total_biz_sale_amt: sumBiz, a_total_cor_sale_amt: sumCor } 
                )
            }
        });
    };
    ...
    useEffect(()=> {
        ...
        if (show === false) {
            setSumBiz(0);
            setSumCor(0);
            setInputValues({biz: {}, cor: {}, a_product_name: '', a_total_biz_sale_amt: 0, a_total_cor_sale_amt: 0});
            setSelectedBizKeys([]);
            setSelectedCorKeys([]);
            setIsSelected(false);
        }

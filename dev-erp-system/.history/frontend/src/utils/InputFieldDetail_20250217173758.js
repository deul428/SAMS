...
/* 
    ...
    useEffect(() => {
        ...
        const [great_classi_code, small_classi_code, sale_amt, delegate_tf, a_mode] = result;
        console.log([great_classi_code, small_classi_code, sale_amt, delegate_tf, a_mode]);
        result.map((e, index) => {

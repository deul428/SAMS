              ...
              {Object.entries(groupedData).map(([biz_opp_id, group], groupIndex) => {
                ...
                return (
                  ...
                  <div key={groupIndex} className='mb-4 d-flex flex-column'>
                    ...
                    <tbody>
                      <div className='row'>
                        <div className='col col_contractDate col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>계약 일자</th>
                          <td>{commonInfo.contract_date.replace(/(\d{4})(\d{2})(\d{2})/g, '$1-$2-$3')}</td>
                        </div>
                        <div className='col col_saleDate col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>매출 일자</th>
                          <td>{commonInfo.sale_date.replace(/(\d{4})(\d{2})(\d{2})/g, '$1-$2-$3')}</td>
                        </div>
                        <div className='col col_saleAmt col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>매출 금액</th>
                    ...
                    <tbody>
                      <div className='row'>
                        <div className='col col_saleProfit col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>매출 이익</th>
                          <td>{commonInfo.sale_profit.toLocaleString('ko-KR')}</td>
                        </div>
                        <div className='col col_sectionName col_10 col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>대표 사업 구분</th>
                          <td>{commonInfo.delegate_biz_section2_name}</td>
                        </div>
                        <div className='col col_comName col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>대표 제조사명</th>

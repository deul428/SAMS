...
/* 
    ...
    const treeRender = (listData, propsData, current, type) => {
 ...
 */
    ...
    const saveData = () => {
        ...
        setTimeout(() => {
            onHide(true);
            treeRender(listData, null, current, '저장')
        }, 100);
    };
                                    ...
                                    <div className="inputField">
                                        ...
                                        <Row className="cntntArea">
                                            <Col xs={12} md={12} lg={6} xl={6} className="cntnt textArea">
                                                ...
                                                treeData={treeRender(listBizData, propsBizData, null, 'biz')} 
                                            ...
                                            <Col xs={12} md={12} lg={6} xl={6} className="cntnt">
                                                ...
                                                <Tree ref={treeRef} multiple checkStrictly 
                                                treeData={treeRender(listCorData, propsCorData, null, 'cor')} 

...
/* 
    ...
    const treeRender = (listData, propsData, type) => {
        ...
        return listData.map((e, index) => {
            ...
            console.log(/* propsMap, matchedData, */ inputValues[e.great_classi_code.toLowerCase()][1], e.small_classi_code);
            return {
                title: (
                    <div className="titleArea"
                        ...
                        <div className={`${index} titleItem`} data-key={`${type}-${index}`}>
                            ...
                            <input
                                type="number"
                                placeholder="세부 금액"
                                value={inputValues[e.small_classi_code]?.[1] ?? matchedData.sale_amt}
                                ...
                                onChange={(e) => {
                                    ...
                                    handleInputChange(e, type, e.target.dataset.code, false)}
                                }
                                onClick={(e) => e.stopPropagation()}
                            />
                        </div>

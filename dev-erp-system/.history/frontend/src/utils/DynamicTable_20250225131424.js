                            ...
                            <Collapse in={openStates[biz_opp_id] || false}>
                              <div className='row'>
                                <div id={`collapse-${biz_opp_id}`} className='collapseBox' key={index} onClick={(e) => openModal(e, group[index], 'activity')}>
                                  <div className='col col_detailNo col-xl-4 col-lg-2 col-md-4 col-12'>
                                    <th>상세 번호</th>
                                    <td>{item.detail_no}</td>
                                  </div>
                                  <div className='col col_actDate col-xl-4 col-lg-2 col-md-4 col-12'>
                                    <th>활동 일자</th>
                                    <td>{item.activity_date.replace(/(\d{4})(\d{2})(\d{2})/g, '$1-$2-$3')}</td>
                                  </div>
                                  <div className='col col_actDetail col-xl-4 col-lg-8 col-md-4 col-12'>
                                    <th>활동 내역</th>

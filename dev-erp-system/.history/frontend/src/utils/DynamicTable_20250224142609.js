              ...
              {Object.entries(groupedData).map(([biz_opp_id, group], groupIndex) => {
                ...
                return (
                  ...
                  <div key={groupIndex} className='mb-4 d-flex flex-column'>
                    <tbody>
                      <div className='row'>
                        <div className='col col-xl-4 col-lg-4 col-md-12 col-12'>
                          <th>사업 번호</th>
                          <td>{commonInfo.biz_opp_id}</td>
                        </div>
                        <div className='col col-xl-8 col-lg-8 col-md-12 col-12'>
                          <th>사업명</th>
                      ...
                      (
                        ...
                        <tbody>
                          {group.map((item, index) => (
                            ...
                            <Collapse in={openStates[biz_opp_id] || false}>
                              <div className='row'>
                                <div id={`collapse-${biz_opp_id}`} className='collapseBox' key={index} onClick={(e) => openModal(e, group[index], 'activity')}>
                                  <div className='col col_01 col-xl-2 col-lg-2 col-md-4 col-12'>
                                    <th>상세 번호</th>
                                    <td>{item.detail_no}</td>
                                  </div>
                                  <div className='col col_02 col-xl-2 col-lg-2 col-md-4 col-12'>
                                    <th>활동 일자</th>
                                    <td>{item.activity_date.replace(/(\d{4})(\d{2})(\d{2})/g, '$1-$2-$3')}</td>
                                  </div>
                                  <div className='col col_03 col-xl-8 col-lg-8 col-md-4 col-12'>
                                    <th>활동 내역</th>
                            ...
                            <div className='row'>
                              <div id={`collapse-${biz_opp_id}`} className='collapseBox' key={index} onClick={(e) => openModal(e, group[index], 'activity')}>
                                <div className='col col_04 col-xl-2 col-lg-4 col-md-4 col-12'>
                                  <th>상세 번호</th>
                                  <td>{item.detail_no}</td>
                                </div>
                                <div className='col col_05 col-xl-2 col-lg-4 col-md-4 col-12'>
                                  <th>활동 일자</th>
                                  <td>{item.activity_date.replace(/(\d{4})(\d{2})(\d{2})/g, '$1-$2-$3')}</td>
                                </div>
                                <div className='col col_06 col-xl-8 col-lg-4 col-md-4 col-12'>
                                  <th>활동 내역</th>
                                  <td className='activityDetails'>{item.activity_details}</td>
                                </div>
                              </div>
                        ...
                        {group.map((item, index) => (
                          <div className='row'>
                            <div id={`collapse-${biz_opp_id}`} className='collapseBox' key={index} onClick={(e) => openModal(e, group[index], 'activity')}>
                              ...
                              <div className='col col-xl-8 col-lg-4 col-md-4 col-12'>
                                <th>활동 내역</th>

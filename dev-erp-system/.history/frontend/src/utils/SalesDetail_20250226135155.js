                                    ...
                                    <div className="inputField">
                                        ...
                                        <Row className="cntntArea">
                                            <Col xs={12} md={12} lg={6} xl={6} className="cntnt textArea">
                                                ...
                                                <h4>현재 사업 구분 금액: &#65510;{v_modalPropsData ? v_modalPropsData?.sale_amt.toLocaleString('ko-KR') : sumBiz.toLocaleString('ko-KR')}</h4>
                                            ...
                                            <Col xs={12} md={12} lg={6} xl={6} className="cntnt">
                                                ...
                                                {/* <h4>총 매출 금액 &#40;변경 값&#41;: &#65510;{totalSaleAmt.toLocaleString('ko-KR')}</h4> */}
                                                <h4>현재 제조사명 금액: &#65510;{v_modalPropsData ? v_modalPropsData?.sale_amt.toLocaleString('ko-KR') : sumCor.toLocaleString('ko-KR')}</h4>
                                                <Tree ref={treeRef} multiple checkStrictly 
